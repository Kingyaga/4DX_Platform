...
export default function ScoreboardPage() {
  ...
  const renderContent = () => (
    <>
      ...
      <div style={{ backgroundColor: "#ffffff", border: "1px solid #e4e4e7", padding: "24px", marginBottom: "24px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "16px" }}>
          <div>
            ...
            <span style={{ fontSize: displayMode ? "48px" : "32px", fontWeight: 700, letterSpacing: "-0.03em", color: "#18181b" }}>
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <span style={{ fontSize: "12px", color: "#71717a", display: "block", marginTop: "4px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: displayMode ? "1fr 1fr 1fr" : "1fr 1fr", gap: "16px" }}>
          ...
          return (
            <div key={lm.id} style={{ backgroundColor: "#ffffff", border: "1px solid #e4e4e7", padding: "20px" }}>
              ...
              <div style={{ display: "flex", alignItems: "flex-end", gap: "8px", marginBottom: "12px" }}>
                <span style={{ fontSize: displayMode ? "40px" : "32px", fontWeight: 700, color: "#18181b", letterSpacing: "-0.03em" }}>{current}</span>
                <span style={{ fontSize: "16px", color: "#71717a", marginBottom: "6px" }}>/ {lm.targetValue} {lm.unit}</span>
              </div>
              ...
              {ownerList.length > 0 && (
                <div style={{ marginBottom: "16px", borderTop: "1px solid #f4f4f5", paddingTop: "12px" }}>
                  <span style={{ fontSize: "11px", fontWeight: 600, letterSpacing: "0.05em", textTransform: "uppercase", color: "#71717a", display: "block", marginBottom: "8px" }}>By Owner</span>
                  <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                    {ownerList.map((owner) => (
                      <div key={owner.name} style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <span style={{ fontSize: "12px", color: "#52525b" }}>{owner.name}</span>
                        <span style={{ fontSize: "12px", fontWeight: 600, color: "#18181b" }}>{owner.total.toFixed(1)} {lm.unit}</span>
                      </div>
                    ))}
                  </div>
                </div>
  ...
  return (
    <main style={{ flex: 1, padding: "32px", fontFamily: "'Inter', sans-serif" }}>
      ...
      {/* Content */}
      {!isLoading && !error && selected && renderContent()}
