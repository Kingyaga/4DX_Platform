...
export default function ActivityLogPage() {
  ...
  const [selectedLeadMeasureId, setSelectedLeadMeasureId] =
    useState<string>("");
      ...
      (wigs as any[]).flatMap((wig) =>
        (wig.leadMeasures || [])
          .filter(
            (lm: LeadMeasure) =>
              !user?.id ||
              (lm.owners || []).some((owner) => owner.userId === user.id),
          )
          .map((lm: LeadMeasure) => ({
            id: lm.id,
            name: lm.name,
  ...
  const selectedLM = allLeadMeasures.find(
    (lm) => lm.id === selectedLeadMeasureId,
  );
  const selectedUnit =
    selectedLM?.unit && selectedLM.unit.toLowerCase() !== "none"
      ? selectedLM.unit
      : "";
  ...
  const visibleLogs = showAllLogs
    ? sortedLogs
    : sortedLogs.slice(0, PREVIEW_COUNT);

  const handleSubmit = async (e: FormEvent) => {
    e.preventDefault();
    if (!currentTeamSlug || !selectedLeadMeasureId || !value || !logDate)
      return;
  ...
  return (
    <main
      style={{ flex: 1, padding: "32px", fontFamily: "'Inter', sans-serif" }}
    >
      {/* Header */}
      <div
        style={{
      ...
      >
        ...
        <p style={{ fontSize: "14px", color: "#71717a", marginTop: "4px" }}>
          Submit activity as a request. Your team lead must approve it before
          the log appears on the scoreboard.
        </p>
      </div>
      {error && (
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        ...
        >
          <div
            style={{ paddingBottom: "16px", borderBottom: "1px solid #e4e4e7" }}
          >
            <h2
              style={{
                fontSize: "24px",
            ...
            <p style={{ fontSize: "14px", color: "#71717a", marginTop: "4px" }}>
              Log your lead measure performance to update the scoreboard
              instantly.
            </p>
          </div>
            ...
            <div style={{ position: "relative" }}>
              <select
                ...
                style={{
                  ...
                  border: "1px solid #e4e4e7",
                  backgroundColor:
                    isLoading || !hasLeadMeasures ? "#f4f4f5" : "#ffffff",
                  fontSize: "16px",
                  color: "#18181b",
                  outline: "none",
                  borderRadius: "0",
                  appearance: "none",
                  cursor:
                    isLoading || !hasLeadMeasures ? "not-allowed" : "pointer",
                }}
              >
                <option value="" disabled>
                  {isLoading
                    ? "Loading lead measures..."
                    : hasLeadMeasures
                      ? "Select a lead measure"
                      : "No lead measures available"}
                </option>
          ...
          {!hasLeadMeasures && (
            ...
            >
              You do not own any lead measures on this team yet. Ask your team
              lead to assign you before submitting activity.
            </div>
          )}
          ...
          <button
            ...
            style={{
              ...
              width: "100%",
              backgroundColor:
                isSubmitting || isLoading || !hasLeadMeasures
                  ? "#a1a1a1"
                  : "#000000",
              color: "#ffffff",
              fontSize: "12px",
        ...
        >
                  ...
                  <div key={log.id} style={{ marginBottom: "8px" }}>
                    ...
                    >
                      <div>
                        ...
                        >
                          {log.leadMeasure?.name ?? "Lead Measure"}
                        </span>
                        <span
                          style={{
                            fontSize: "12px",
                        ...
                        >
                          {new Date(log.loggedForDate).toLocaleDateString()}
                        </span>
                      </div>
                      <div
                        style={{
                      ...
                      >
                        ...
                        >
                          {log.value} {log.leadMeasure?.unit ?? ""}
                        </span>
                        <span
                          style={{
                            fontSize: "11px",
          ...
          {isLoading ? (
            ...
            <EmptyState
              ...
              description="Start logging lead measure values to build your activity history."
            />
          ) : (
            <div
              style={{
                  ...
                  {visibleLogs.map((log: any, i: number) => {
                    ...
                    <tr
                      ...
                      style={{
                        ...
                        backgroundColor:
                          hoveredRow === i ? "#f7f9fd" : "transparent",
